...
import com.MingYi.coupon.constant.CouponStatus;
import com.MingYi.coupon.dao.CouponDao;
import com.MingYi.coupon.entity.Coupon;
import com.MingYi.coupon.exception.CouponException;
import com.MingYi.coupon.feign.SettlementClient;
import com.MingYi.coupon.feign.TemplateClient;
import com.MingYi.coupon.service.IRedisService;
import com.MingYi.coupon.service.IUserService;
import com.MingYi.coupon.vo.*;
...
/**
 * <h1>用户服务相关的接口实现</h1>
 * 所有的操作过程, 状态都保存在 Redis 中, 并通过 Kafka 把消息传递到 MySQL 中 : 高性能保证
 * 为什么使用 Kafka, 而不是直接使用 SpringBoot 中的异步处理? 安全性，异步操作会失败
 */
...
public class UserServiceImpl implements IUserService {
    ...
    public List<Coupon> findCouponsByStatus(Long userId, Integer status) throws CouponException {
        ...
        if (CollectionUtils.isNotEmpty(curCached)) {
            ...
            // 填充 dbCoupons的 templateSDK 字段,这个字段不属于表的
